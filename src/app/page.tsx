		...
		<main className='flex min-h-screen flex-col gap-8 max-w-8xl mx-auto p-4 md:p-16'>
			<div className=''>
				...
				<p className='text-xs text-gray-700'>
					This app is built for managing and keeping track of my applied jobs. If you are reading this, then it means that this application
					is not yet completely built and it is out because of my current job search.{' '}
