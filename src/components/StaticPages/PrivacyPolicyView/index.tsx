		...
		<div className="mx-auto py-8 motion-preset-slide-down">
			<Card className="w-full max-w-3xl mx-auto">
				<CardHeader>
					...
					<CardDescription className="text-center">Last Updated: {lastUpdated}</CardDescription>
				</CardHeader>
				<CardContent>
					...
					<Accordion type="multiple" className="w-full">
						<AccordionItem value="item-1">
							...
							<AccordionContent>
								...
								<ul className="list-disc list-inside text-muted-foreground">
									...
									<li>
										<strong>Application Data:</strong> Job application details you enter, including
										company names, positions, and interview notes
									</li>
									<li>
										<strong>Uploaded Files:</strong> Files and images attached to your job
										applications
									</li>
								</ul>
							</AccordionContent>
						...
						<AccordionItem value="item-2">
							...
							<AccordionContent>
								...
								<ul className="list-disc list-inside text-muted-foreground">
									...
									<li>
										<strong>Application Tracking:</strong> Storing job application details, files,
										and interview notes
									</li>
									<li>
										<strong>Improvements:</strong> To improve our platform and develop new features
						...
						<AccordionItem value="item-6">
							<AccordionTrigger>6. Changes to Privacy Policy</AccordionTrigger>
							<AccordionContent>
								<p>
									We may update this policy as our services evolve. All changes will be posted on this
