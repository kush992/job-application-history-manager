...
const ApplicationFilter: React.FC<Props> = ({
	...
	return (
		<form
			className="w-full flex sm:flex-row flex-col items-center gap-2"
			...
			<div className="flex items-center w-full gap-2">
				<Select onValueChange={filterByStatus} defaultValue="">
					...
					<SelectContent>
						...
						<SelectItem
							value={ApplicationStatus.REJECTED_NO_FEEDBACK}
						>
							Rejected no feedback
						</SelectItem>
						<SelectItem
							value={ApplicationStatus.REJECTED_WITH_FEEDBACK}
						>
